...
const INTRO_STEPS: Step[] = [
  {
    ...
    text: "Это не лента по подпискам. Ты отмечаешь свой вайб — На движе, Спокойно, Выжат или В работе — и видишь тех, кто в твоём городе чувствует то же самое прямо сейчас.",
  },
  {
    title: "Заяви своё состояние",
    text: "Нажимая на вайб, ты заявляешь состояние, а не просто фильтруешь ленту. Хочешь просто посмотреть весь город — переключи «Только мой вайб» на «Все».",
  },
  {
  ...
  {
    title: "🔒 Связь только по обоюдному согласию",
    text: "Понравился пост — жми «Хочу законнектиться». Место, время и контакт откроются, только если человек примет запрос. Откажет — ты просто увидишь «Отклонено», без объяснений и без второй попытки.",
    highlight: true,
  },
  {
    title: "🔒 Переписка исчезает без следа",
    text: "После согласия чат живёт ровно 24 часа и потом пропадает — история не хранится. Можно и раньше завершить его вручную и заблокировать собеседника.",
    highlight: true,
  },
];
...
const TIPS_STEPS: Step[] = [
  {
    title: "Аккаунт готов 🎉",
    text: "Коротко покажу, что где.",
  },
  {
    title: "Публикуй",
    text: "Поле «Что у тебя происходит…» — пиши текст, добавляй фото, место и время встречи.",
  },
  {
    title: "🔒 Твой логин под защитой",
    text: "Логин, который виден под твоим именем, никто не увидит без твоего согласия — даже если тебя упомянут в чужом посте.",
    highlight: true,
  },
  {
    title: "🔔 Запросы на связь",
    text: "Значок в шапке — сюда приходят входящие запросы «Хочу законнектиться». Принимай или отклоняй сам.",
  },
  {
