    ...
    <div className="mb-6 flex flex-col gap-3">
      <div className="rounded-2xl p-4 text-sm" style={{ background: "var(--bg-elevated)", border: "1px solid var(--border)" }}>
        ...
        <p style={{ color: "var(--fg-muted)" }}>
          ...
          отправляешь запрос на связь, и после согласия открывается чат на 24 часа.
        </p>
      </div>
      <div
      ...
      >
        ...
        <p style={{ color: "var(--fg-muted)" }}>
          Без входа лента вообще не видна. Даже после согласия на связь логин, место встречи и
          контакт остаются скрыты — открыть их можно только вручную, кнопкой «Доверять», когда
          сам решишь, что человеку можно верить. Отказ — без объяснений и без повторных попыток.
