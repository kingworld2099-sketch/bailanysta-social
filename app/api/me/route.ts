...
import { normalizeName, normalizeCity, normalizeOptional, normalizeIconsSide } from "@/lib/validation";
...
export async function PATCH(req: NextRequest) {
  try {
    ...
    if (body.headerIconsSide !== undefined) data.headerIconsSide = normalizeIconsSide(body.headerIconsSide);
